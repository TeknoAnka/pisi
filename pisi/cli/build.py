...
class Build(command.Command, metaclass=command.autocommand):
    ...
    def add_steps_options(self):
        ...
        group.add_option(
            ...
            const="unpack",
            help=_(
                "Break build after unpacking the source "
    ...
    def run(self):
        if "__compiled__" in globals():
            raise pisi.Error(_("Building packages is not supported when pisi is compiled with nuitka. Please use pisi.py instead."))
