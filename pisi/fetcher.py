# SPDX-FileCopyrightText: 2005-2011 TUBITAK/UEKAE, 2013-2017 Ikey Doherty, 2026-2027 Solzic0, LupuSzic0, LupuS, 2026 LupuS Project
...
class Fetcher:
    ...
    def __init__(self):
        ...
        self.session.headers.update({"User-Agent": f"pisi Fetcher/{pisi.__version__}"})
