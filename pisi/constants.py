...
class Constants(metaclass=Singleton):
    ...
    def __init__(self):
        ...
        self.__c.work_dir_suffix = (
            "/work"  # these, too, because we might wanna change 'em
        )
        ...
        # Legacy cruft on LupuS, lupus won't support this
        self.__c.mirrors_conf = "/usr/share/defaults/pisi/mirrors.conf"
        self.__c.sandbox_conf = "/usr/share/defaults/pisi/sandbox.conf"
