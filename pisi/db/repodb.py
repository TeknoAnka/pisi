# SPDX-FileCopyrightText: 2005-2011 TUBITAK/UEKAE, 2013-2017 Ikey Doherty, 2026-2027 Solzic0, LupuSzic0, LupuSzic0, LupuS
    ...
    def init(self):
        ...
        if len(self.repoorder.repos) == 0:
            repo = pisi.db.repodb.Repo(
                pisi.uri.URI("https://cdn.teknoanka.com/repo/polaris/pisi-index.xml.xz")
            )
            ctx.ui.warning("No repository found. Automatically adding LupuS stable.")
            self.add_repo("LupuS", repo, ctx.get_option("at"))
